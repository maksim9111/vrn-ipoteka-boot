  ...
  <div class="container py-3">
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-12 col-md-3 py-3 d-none d-lg-block">
          <p class="text-secondary text-uppercase">сервисы</p>
          <p><a href="" class="text-white none-decoration-a text-uppercase">ипотека</a></p>
          <p><a href="" class="text-white none-decoration-a text-uppercase">жилые комплексы</a></p>
          <p><a href="" class="text-white none-decoration-a text-uppercase">каталог компаний</a></p>
          <p><a href="" class="text-white none-decoration-a text-uppercase">о компании</a></p>
          <p><a href="" class="text-white none-decoration-a text-uppercase">контакты</a></p>
      </div>
      <div class="col-xs-12 col-sm-12 col-md-3 py-3 d-none d-lg-block">

<!--           <p>Полезная информация</p> -->
          <p class="text-secondary text-uppercase">полезная информация</p>
          <p><a href="" class="text-white none-decoration-a">Первичная консультация</a></p>
          <p><a href="" class="text-white none-decoration-a">Рефинансирование</a></p>
...
<!--           <p>Полезная информация</p> -->
          <p class="text-secondary text-uppercase">полезная информация</p>
          <p><a href="" class="text-white none-decoration-a">Передача документов</a></p>
          <p><a href="" class="text-white none-decoration-a">Переговоры с банками</a></p>
