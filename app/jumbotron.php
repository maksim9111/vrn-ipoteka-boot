...
<div class="jumbotron">
        <div class="container">
            ...
            <p class="mt-4"><a class="btn btn-danger px-4" href="#" role="button"  data-toggle="modal" data-target="#fosTop">Купить недвижимость &raquo;</a></p>
        </div>
</div>
<?php
require_once('obratcall.php');
require_once('persdannie.php');
?>
